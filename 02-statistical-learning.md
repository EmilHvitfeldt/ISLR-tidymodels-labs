...
The charts whenever possible will be created using ggplot2, if you are unfamiliar with ggplot2 I would recommend you start by reading the [Data Visualisation](https://r4ds.hadley.nz/data-visualize.html) chapter of the [R for Data Science (2e)](https://r4ds.hadley.nz/) book.
